...
Primarily included to ensure JS translations work as JSON translation files need this as the source, minified version enqueued in wp_enqueue_script with wp_set_script_translations which links everything together
Not possible to extract strings from /client source files then enqueued from the equivalent in /assets, the non-minified version is used as wp i18n make-pot ignores .min.js files
*/
