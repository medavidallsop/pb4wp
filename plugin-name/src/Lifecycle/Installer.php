...
class Installer {
	...
	public static function install(): void {
		// Do any installation tasks above, then update the version number so in future the installer doesn't run again and the updater knows the current version to compare to.
