...
class Updater {
	...
	public static function update(): void {
		// Do any update tasks above using version_compare of the plugin_name_version then update the version number so in future the updater knows the current version to compare to.
